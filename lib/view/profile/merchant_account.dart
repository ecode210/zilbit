...
class MerchantAccount extends GetWidget<ProfileController> {
  const MerchantAccount({Key? key}) : super(key: key);
                ...
                child: SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      Text(
                        "Become a Merchant. Fill the form below to apply for a merchant’s account",
                      ...
                      const ProfileTextField(
                        textInputType: TextInputType.name,
                        hint: "The name you'd be seen as",
                      ),
                      SizedBox(height: 20.h),
                      Align(
                        alignment: Alignment.centerLeft,
                            ...
                            () {
                              return Transform.scale(
                                ...
                                child: SizedBox(
                                  ...
                                  width: 25.h,
                                  child: Checkbox(
                                    value: controller.merchantRegister.value,
                                    fillColor: MaterialStateProperty.all(priColor),
                                    checkColor: whiteColor,
                                    shape: const StadiumBorder(),
                                    splashRadius: 10,
                                    onChanged: (value) {
                                      controller.merchantRegister.value = value!;
                                    },
                                  ),
                                ),
                              );
